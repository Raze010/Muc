...
class LectureTransactionEtoro
{
    ...
    public static function Lire($fichier, $utilisateur, SessionInterface $sessionInterface, ManagerRegistry $doctrine)
    {
        ...
        try {
            ...
            $sessionInterface->set( 'bvn_message_couleur','message_vert');
